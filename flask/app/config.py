...
#SQLALCHEMY_DATABASE_URI = 'sqlite:///C:/repos/cloud/flask/app/instance/cloud.db' #for local host
SQLALCHEMY_DATABASE_URI = 'sqlite:///cloud.db' #for remote host
